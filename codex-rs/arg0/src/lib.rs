...
const LINUX_SANDBOX_ARG0: &str = "zenith-linux-sandbox";
...
/// `zenith-linux-sandbox` we *directly* execute
/// [`zenith_linux_sandbox::run_main`] (which never returns). Otherwise we:
///

            ...
            match event {
                ...
                TuiEvent::Draw => {
                    ...
                    tui.draw(tui.terminal.size()?.height, |frame| {
                        // Plan is now rendered inside BottomPane (part of ChatWidget),
                        // so chat_height includes the plan display.
                        ...
                        // Render chat widget (includes plan display in bottom pane).
                        let chat_area = Rect {
                            x: frame.area().x,
                            y: chat_top,
        ...
        if matches!(
            self.transcript_scrollbar_ui
                .handle_mouse_event(TranscriptScrollbarMouseEvent {
                    ...
                    verbose: self.chat_widget.is_verbose(),
                }),
